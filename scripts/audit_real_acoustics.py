...
def capture_run(args):
    ...
    from inspark_infer.runtime.deployment import load as deployment_load
...
def main():
    ...
    capture.add_argument("--corpus", type=Path, default=Path("configs/hardware/sm89/sm89_quality_256.json"))
