...
def main():
    ...
    p.add_argument("--config",default="configs/common/runtime.yaml")
    p.add_argument("--deployment",default="configs/hardware/sm89/sm89_bf16_current_fair.json")
    ...
    from inspark_infer.ops.triton.draft_attention import attention
    from inspark_infer.runtime.deployment import load as load_deployment
    from inspark_infer.runtime.engine import Engine
    from inspark_infer.ops.tensorrt.native113 import _import_trt113, _make_draft_mask
