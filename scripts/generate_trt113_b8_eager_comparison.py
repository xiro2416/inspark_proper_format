...
def main() -> None:
    ...
    candidate.add_argument("--config", default="configs/common/runtime.yaml")
    candidate.add_argument("--deployment", default="configs/hardware/sm89/sm89_bf16_trt113_target_draft_b8.json")
