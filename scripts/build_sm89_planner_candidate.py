...
from inspark_infer.ops.planning.v2.deploy import model_hash, source_hash, toolchain
from inspark_infer.ops.planning.v2.inventory import canonical_inventory, keyed, tunable
from inspark_infer.ops.planning.v2.manifest import DeploymentManifest, RolePolicy
...
def main() -> None:
    ...
    parser.add_argument("--config", type=Path, default=Path("configs/common/runtime.yaml"))
