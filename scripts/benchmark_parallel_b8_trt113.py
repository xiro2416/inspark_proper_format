...
def main():
    ...
    from acc_infer_clear.parallel_b8_experiment import (
        fork_engine, install_b8_only_graph_policy, install_shared_engine_classes,
        make_lane_plan, memory_snapshot,
    )
