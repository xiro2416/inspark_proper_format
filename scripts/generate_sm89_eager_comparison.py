...
def main() -> None:
    ...
    optimized.add_argument("--config", default="configs/common/runtime.yaml")
    optimized.add_argument("--deployment", default="configs/hardware/sm89/sm89_bf16_triton_device_control_alias_candidate.json")
