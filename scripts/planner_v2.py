...
from inspark_infer.ops.planning.v2.formulas import generate_candidates
from inspark_infer.ops.planning.v2.inventory import canonical_inventory, keyed, tunable
from inspark_infer.ops.planning.v2.manifest import DeploymentManifest, RolePolicy, load
...
def command_shadow(args):
    ...
    if args.current_config:
        ...
        from inspark_infer.ops.planning.v2.deploy import model_hash as hash_model, source_hash as hash_source, toolchain as current_toolchain
