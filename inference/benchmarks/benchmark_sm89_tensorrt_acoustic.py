...
def main():
    ...
    from acc_infer_clear.ops.triton.alias_free import install as install_alias
    from acc_infer_clear.ops.triton.stage2_fusions import install as install_cfm
