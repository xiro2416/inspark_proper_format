...
def main():
    ...
    from acc_infer_clear.ops.triton.device_commit import mark_keep
    from acc_infer_clear.ops.triton.kv_attention import append, attention
    from acc_infer_clear.ops.tensorrt.native113 import NativeTargetAttention113, NativeTargetFull113
