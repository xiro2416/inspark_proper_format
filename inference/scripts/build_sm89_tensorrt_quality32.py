...
def main():
    ...
    parser.add_argument('--texts',type=Path,default=Path('configs/sm89_benchmark_32_texts.json'))
    ...
    parser.add_argument('--output',type=Path,default=Path('configs/sm89_tensorrt_quality32.json'))
