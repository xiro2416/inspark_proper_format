...
from acc_infer_clear.models.indextts2.upstream.utils.maskgct.models.codec.amphion_codec.quantize.factorized_vector_quantize import FactorizedVectorQuantize
from acc_infer_clear.models.indextts2.upstream.utils.maskgct.models.codec.amphion_codec.quantize.vector_quantize import VectorQuantize
from acc_infer_clear.models.indextts2.upstream.utils.maskgct.models.codec.amphion_codec.quantize.lookup_free_quantize import LookupFreeQuantize
...
class ResidualVQ(nn.Module):
    ...
    def __init__(self, input_dim: int=256, num_quantizers: int=8, codebook_size: int=1024, codebook_dim: int=256, quantizer_type: str='vq', quantizer_dropout: float=0.5, **kwargs):
        super().__init__()
        ...
        self.quantizers = nn.ModuleList([VQ(input_dim=input_dim, codebook_size=codebook_size, codebook_dim=codebook_dim, **kwargs) for _ in range(num_quantizers)])
    ...
    def forward(self, z, n_quantizers: int=None):
        ...
        all_commit_losses, all_codebook_losses, all_indices, all_quantized = map(torch.stack, (all_commit_losses, all_codebook_losses, all_indices, all_quantized))
