...
from acc_infer_clear.models.indextts2.upstream.gpt.conformer.attention import MultiHeadedAttention, RelPositionMultiHeadedAttention
from acc_infer_clear.models.indextts2.upstream.gpt.conformer.embedding import NoPositionalEncoding, PositionalEncoding, RelPositionalEncoding
from acc_infer_clear.models.indextts2.upstream.gpt.conformer.subsampling import Conv2dSubsampling2, Conv2dSubsampling4, Conv2dSubsampling6, Conv2dSubsampling8, LinearNoSubsampling
from acc_infer_clear.models.indextts2.upstream.utils.common import make_pad_mask
...
class ConformerEncoderLayer(nn.Module):
    ...
    def __init__(self, size: int, self_attn: torch.nn.Module, feed_forward: Optional[nn.Module]=None, feed_forward_macaron: Optional[nn.Module]=None, conv_module: Optional[nn.Module]=None, dropout_rate: float=0.1, normalize_before: bool=True, concat_after: bool=False):
...
class BaseEncoder(torch.nn.Module):
    ...
    def __init__(self, input_size: int, output_size: int=256, attention_heads: int=4, linear_units: int=2048, num_blocks: int=6, dropout_rate: float=0.0, input_layer: str='conv2d', pos_enc_layer_type: str='abs_pos', normalize_before: bool=True, concat_after: bool=False):
        """
        Args:
...
class ConformerEncoder(BaseEncoder):
    ...
    def __init__(self, input_size: int, output_size: int=256, attention_heads: int=4, linear_units: int=2048, num_blocks: int=6, dropout_rate: float=0.0, input_layer: str='conv2d', pos_enc_layer_type: str='rel_pos', normalize_before: bool=True, concat_after: bool=False, macaron_style: bool=False, use_cnn_module: bool=True, cnn_module_kernel: int=15):
        ...
        """
        super().__init__(input_size, output_size, attention_heads, linear_units, num_blocks, dropout_rate, input_layer, pos_enc_layer_type, normalize_before, concat_after)
