...
def attach_target(engine):
    from acc_infer_clear.ops.triton.unified_ar.target import attach as attention
    from acc_infer_clear.ops.triton.unified_ar.linear import attach as linear
...
def attach_draft(engine):
    from acc_infer_clear.ops.triton.unified_ar.draft import attach
