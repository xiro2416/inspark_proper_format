...
import torch
from acc_infer_clear.ops.triton.acoustic_pipeline.deploy import identity as base_identity
from acc_infer_clear.ops.triton.alias_free import FusedAliasFree
from acc_infer_clear.ops.triton.acoustic.stage2 import SelectedConv, SelectedLinear
from acc_infer_clear.ops.triton.acoustic_refine.alias import run
from acc_infer_clear.ops.triton.acoustic_refine.wavenet import RefinedWaveNet
def identity():
