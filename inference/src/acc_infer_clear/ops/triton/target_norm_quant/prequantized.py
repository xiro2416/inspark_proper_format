...
import torch
import triton
from acc_infer_clear.ops.triton.fp8 import _quantize, _gemm, _reduce
from acc_infer_clear.ops.triton.stage2_gemm import _gemm_col, _epilogue
from acc_infer_clear.ops.triton.ar_pipeline.gemm import pipeline_gemm
from acc_infer_clear.ops.triton.target_seven.projections import Projection, base_linear
from acc_infer_clear.ops.triton.ar_pipeline.deploy import PipelineLinear
from acc_infer_clear.ops.triton.ar_refine.deploy import RefinedLinear
from acc_infer_clear.ops.eager.matrix import MatrixLinear

def resolve(module,m):
    from acc_infer_clear.ops.triton.target_full_m.deploy import FullMLinear
...
class Prepared:
    ...
    def full(self,x):
        ...
        from acc_infer_clear.ops.triton.ar_pipeline.gemm import run
        ...
        if p['kind']=='full_m':
            from acc_infer_clear.ops.triton.target_full_m.tiled import run as full_m
