...
from inspark_infer.models.indextts2.upstream.s2mel.modules.encodec import SConv1d
from inspark_infer.models.indextts2.upstream.s2mel.modules import commons
LRELU_SLOPE = 0.1
...
class WN(torch.nn.Module):
    ...
    def __init__(self, hidden_channels, kernel_size, dilation_rate, n_layers, gin_channels=0, p_dropout=0, causal=False):
        ...
        for i in range(n_layers):
            ...
            in_layer = conv1d_type(hidden_channels, 2 * hidden_channels, kernel_size, dilation=dilation, padding=padding, norm='weight_norm', causal=causal)
