...
def attach_target(engine):
    from inspark_infer.ops.triton.unified_ar.target import attach as attention
    from inspark_infer.ops.triton.unified_ar.linear import attach as linear
...
def attach_draft(engine):
    from inspark_infer.ops.triton.unified_ar.draft import attach
