...
import torch,triton
from inspark_infer.ops.eager.matrix import MatrixConv
from inspark_infer.ops.planning.planner import DeviceCaps, Tile
...
def prepare(engine,plan_path,mode='both'):
    ...
    if mode in ('alias','both'):
        from inspark_infer.ops.triton.alias_free import install
