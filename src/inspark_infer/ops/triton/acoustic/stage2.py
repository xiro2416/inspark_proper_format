...
import torch,triton
from inspark_infer.ops.eager.matrix import MatrixConv, MatrixLinear
from inspark_infer.ops.eager.layout_conv import LayoutConv
from inspark_infer.ops.planning.planner import Tile, DeviceCaps
from inspark_infer.ops.triton.fp8 import linear
from inspark_infer.ops.triton.stage2_gemm import col_linear
from inspark_infer.ops.triton.stage2_bf16_conv import bf16_conv
...
def prepare(engine,plan_path,parts=('gemm','conv','norm','gate','rope')):
    ...
    from inspark_infer.ops.triton.stage2_fusions import install
