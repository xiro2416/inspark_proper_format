...
import torch,triton
from .conv import conv_pipeline
from acc_infer_clear.kernels.fp8_conv import _partial_max,_scale
from acc_infer_clear.kernels.fp8_conv_ntc import _quant_ntc
