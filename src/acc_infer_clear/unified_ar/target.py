...
from acc_infer_clear.dspark.slot_target import SlotKV
from acc_infer_clear.unified_ar.attention import quantize_vectors,append_fp8,append_qk_fp8,target_attention,quantize_blocks32,target_attention_block32
from acc_infer_clear.unified_ar.qkv import run_target_slots,unified_plan
from acc_infer_clear.kernels.kv_attention import append as append_fp32,attention as attention_fp32
...
def _math(self,x,slots,lengths,limit):
    from acc_infer_clear.target_norm_quant.fused import fused
