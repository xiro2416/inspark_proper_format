...
import types
import torch
from acc_infer_clear.unified_ar.attention import quantize_blocks32,draft_attention_block32
from acc_infer_clear.unified_ar.qkv import run_qkv_mixed
from acc_infer_clear.target_norm_quant.prequantized import quantize
from acc_infer_clear.target_norm_quant.prequantized import binding
from acc_infer_clear.target_seven.projections import base_linear
from acc_infer_clear.target_norm_quant.residual import col_linear_residual
from acc_infer_clear.target_norm_quant.residual_down import run as down_residual
from acc_infer_clear.target_full_m.tiled import run_prequantized
from acc_infer_clear.kernels.draft_attention import attention as attention_fp32
from acc_infer_clear.kernels.context_scatter import scatter_layer,scatter_layer_k8_v32
