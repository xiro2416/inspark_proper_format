...
from .lab import Bank,make,bind

def identity():
 import triton
 root=Path(__file__).resolve().parents[1]
 names=['prefix_padding/lab.py','prefix_padding/deploy.py','kernels/fp8.py','kernels/stage2_gemm.py','runtime/prefix_graphs.py','target_seven/pointwise.py']
