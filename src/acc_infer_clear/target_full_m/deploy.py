...
from acc_infer_clear.target_full_m.tiled import run as full_m_linear
...
def identity():
    ...
    files = [Path(__file__), root / 'target_full_m' / 'tiled.py']
    from acc_infer_clear.target_seven.projections import identity as parent_identity
