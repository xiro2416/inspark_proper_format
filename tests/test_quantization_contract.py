...
from inspark_infer.quantization import precision
...
import sys
import torch
from inspark_infer.quantization.precision import MatrixLinear, MatrixConv
MatrixLinear(torch.nn.Linear(5, 3), 'bf16', None, {})(torch.ones(2, 5))
MatrixConv(torch.nn.Conv1d(2, 3, 3), 'bf16', None, {})(torch.ones(2, 2, 7))
assert not any(name.startswith('inspark_infer.ops.triton.') for name in sys.modules)
"""
