...
from inspark_infer.ops.planning.v2.inventory import canonical_inventory
from inspark_infer.ops.planning.v2.manifest import DeploymentManifest, RolePolicy, load
from inspark_infer.ops.planning.v2.model import HardwareProfile, OperatorSignature, ScheduleSpec
...
class PlannerV2ContractTest(unittest.TestCase):
    ...
    def test_deployment_requires_manifest_for_apply(self):
        root=Path(__file__).resolve().parents[1];plan=json.loads((root/'configs/hardware/sm120/sm120.json').read_text())
