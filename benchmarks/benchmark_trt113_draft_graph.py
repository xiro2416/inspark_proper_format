...
def main():
    ...
    p.add_argument("--config",default="configs/common/runtime.yaml");p.add_argument("--deployment",default="configs/hardware/sm89/sm89_bf16_trt113_draft_lab.json");p.add_argument("--out",required=True);args=p.parse_args()
