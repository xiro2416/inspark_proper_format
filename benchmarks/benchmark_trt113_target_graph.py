...
def main():
    ...
    from inspark_infer.ops.triton.device_commit import mark_keep
    from inspark_infer.ops.triton.kv_attention import append, attention
    from inspark_infer.ops.tensorrt.native113 import NativeTargetAttention113, NativeTargetFull113
