...
Separates the three memory questions that matter for admission headroom:
  ...
  bash scripts/run.sh scripts/profile_sm89_memory.py --gpu 6 --batch 8 \
      --deployment configs/hardware/sm89/sm89_bf16_triton.json --ref-audio outputs/profile_sm89/reference.wav
"""
import argparse
import json
import os
...
def main():
    ...
    parser.add_argument("--deployment", default="configs/hardware/sm89/sm89_bf16_triton.json")
